...
class Fast_turret():
    def __init__(self):
        ...
        self.height = 50
        self.damadge = [1, 1.5]
        self.img = [pygame.transform.scale(pygame.image.load("Images/Fast_turret.png"), (self.width, self.height)), pygame.transform.scale(pygame.image.load("Images/Fast_turret_lvl_1.png"), (self.width, self.height)), False]
        self.range = [300, 330]
        self.shoot_speed = [6, 6]
        self.shoot = (self.x, self.y)
        self.bullets = []
        self.tower_timer = 0
        self.min_shoot_delay = [2, 1.4]
        self.level = 0
        self.selected = False
        self.sell_prices = [30, 50]
        self.level_up_prices = [60]
